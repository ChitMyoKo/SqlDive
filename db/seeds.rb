...
Book.create!(title: "The Force",sales: 500, genre_id: non_fiction.id, author_id: luke.id)
...
Book.create!(title: "DIY Deathstar", genre_id: non_fiction.id, author_id: vader.id,sales: 45)